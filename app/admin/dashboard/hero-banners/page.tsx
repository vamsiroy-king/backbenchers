        ...
        <div className="min-h-screen bg-gray-50 dark:bg-black pb-32 pt-12">
            ...
            <main className="px-4 pt-4 space-y-4">
                ...
                {!loading && banners.map((banner, index) => (
                    ...
                    >
                        {/* Banner Preview */}
                        <div className={`h-24 bg-gradient-to-r ${banner.backgroundGradient} p-4 flex items-end`}>
                            <div>
                                <p className="text-white font-bold text-lg truncate">{banner.title}</p>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="p-4 space-y-4">
                                {/* Preview */}
                                <div className={`h-32 bg-gradient-to-r ${form.backgroundGradient} rounded-2xl p-4 flex flex-col justify-end`}>
                                    <p className="text-white font-bold text-lg">{form.title || 'Banner Title'}</p>
                                    {form.subtitle && <p className="text-white/80 text-sm">{form.subtitle}</p>}
                                    <button className="bg-white text-gray-900 font-semibold px-4 py-1.5 rounded-lg text-sm mt-2 w-fit">
                                        {form.ctaText || 'Button'}
                                    </button>
                                </div>
                                ...
                                {/* City Selection (if city_specific) */}
