    ...
    const handleEmailSignup = async (e: React.FormEvent) => {
        ...
        try {
            const { error: signUpError } = await supabase.auth.signUp({
                ...
                password,
                options: {
                    emailRedirectTo: `${window.location.origin}/recruiter/auth/callback`,
                },
            });
                ...
                {success ? (
                    <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-6 text-center">
                        ...
                        <button
                            ...
                            className="mt-6 text-green-500 font-semibold text-sm hover:text-green-400"
                        >
                            Back to Login
                        </button>
                    </div>
