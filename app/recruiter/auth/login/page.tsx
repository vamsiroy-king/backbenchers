        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-6">
            ...
            >
                ...
                <div className="text-center">
                    <p className="text-white/40 text-xs">Don't have an account?</p>
                    <button onClick={() => router.push('/recruiter/auth/signup')} className="text-green-500 text-sm font-semibold mt-1 hover:text-green-400">
