...
function LandingContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Professional Footer - Industry Standard */}
      <motion.footer
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
      ...
      >
        <div className="px-6 py-8">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-bold">Backbenchers</span>
          </div>
          <p className="text-gray-400 text-xs mb-6">India's #1 Student Discount Platform</p>

          {/* Social Links */}
          <div className="flex gap-3 mb-6">
            <a href="https://instagram.com/backbenchers_official" target="_blank" rel="noopener noreferrer"
              className="h-9 w-9 bg-gray-800 hover:bg-primary rounded-full flex items-center justify-center transition-colors">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs mb-6">
            <Link href="/about" className="text-gray-400 hover:text-white transition-colors py-1">About Us</Link>
            <Link href="/privacy" className="text-gray-400 hover:text-white transition-colors py-1">Privacy Policy</Link>
            <Link href="/terms" className="text-gray-400 hover:text-white transition-colors py-1">Terms of Service</Link>
            <Link href="/contact" className="text-gray-400 hover:text-white transition-colors py-1">Contact Us</Link>
          </div>
          ...
          <div className="text-xs text-gray-500 space-y-1 mb-4">
            <p>📧 support@backbenchers.app</p>
            <p>📍 Hyderabad, India</p>
          </div>

          {/* Copyright */}
          <div className="text-center text-[10px] text-gray-600 pt-4 border-t border-gray-800">
            <p>© {new Date().getFullYear()} Backbenchers. All rights reserved.</p>
