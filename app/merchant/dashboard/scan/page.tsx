        ...
        <div className="min-h-screen bg-black pb-32">
            <AnimatePresence mode="wait">
                ...
                {step === "scanning" && (
                    ...
                    >
                        <h2 className="text-xl font-extrabold text-white mb-2">Scan Student QR Code</h2>
                        <p className="text-white/50 text-sm mb-4">Point camera at student&apos;s Backbenchers QR code</p>
